...
public class JavaCompiler {
     ...
     *
     * @param errors Die Fehler als String in der Form, wie sie javac liefert
     * @param file   Die Hamster-Datei, bei der die Fehler aufgetreten sind
     ...
     *
     * @param file Die zu Compilierende Datei
